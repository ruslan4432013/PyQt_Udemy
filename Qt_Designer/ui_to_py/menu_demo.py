...
# Form implementation generated from reading ui file 'ui\menu_demo.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.splitter.setGeometry(QtCore.QRect(0, 0, 631, 401))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("ui\\../../pictures/imp.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionSimple_Widget = QtWidgets.QAction(MainWindow)
        self.actionSimple_Widget.setObjectName("actionSimple_Widget")
        self.actionLayouts = QtWidgets.QAction(MainWindow)
        self.actionLayouts.setObjectName("actionLayouts")
        self.actionAdvanced_Widget = QtWidgets.QAction(MainWindow)
        self.actionAdvanced_Widget.setObjectName("actionAdvanced_Widget")
        ...
        self.menuExamples.addAction(self.actionSimple_Widget)
        self.menuExamples.addAction(self.actionLayouts)
        self.menuExamples.addAction(self.actionAdvanced_Widget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionSimple_Widget.setText(_translate("MainWindow", "Simple Widget"))
        self.actionLayouts.setText(_translate("MainWindow", "Layouts"))
        self.actionAdvanced_Widget.setText(_translate("MainWindow", "Advanced Widget"))
        ...
        self.actionAbout_us.setShortcut(_translate("MainWindow", "Ctrl+A"))
