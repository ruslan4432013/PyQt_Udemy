...
class DlgMain(QDialog):
    ...
    def evt_rbt_clicked(self):
        ...
        str_style_sheet = f'color:{checked_btg_color_rbt.text()}; font-size:{checked_btg_text_size_rbt_id}px'
