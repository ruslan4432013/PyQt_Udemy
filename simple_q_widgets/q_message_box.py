...
class DlgMain(QDialog):
    ...
    def evt_btn_clicked(self):
        ...
        #     QMessageBox.information(self, '', 'You clicked "Yes button"')
        # else:
        #     QMessageBox.information(self, '', 'You clicked "No button"')
        msgDiskFull = QMessageBox()
        msgDiskFull.setText('Your gard drive is almostfull')
